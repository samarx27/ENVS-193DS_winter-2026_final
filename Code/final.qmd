...
## b. 
The variable for distance to prairie dog colony edge is a continuous variable. This could influence the probability of Mountain Plover nest site use because it increases the vulnerability of the nesting site, which is included in the discussion section of the paper. 
The variable for visual obstruction is a categorical variable. It could influence the probability of Mountain Plover nest site use because it can impact the visibility of the nest to predators, which is included in _. 
